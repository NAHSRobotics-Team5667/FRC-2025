...
public class adjustClampCoral extends Command {
    private EndEffectorSubsystem end_effector;
    private EndEffectorStates state;
    private double targetRotations;
    private double currentPosition;

    public adjustClampCoral(EndEffectorStates state) {
    ...
    public void initialize() {
        if(state.equals(EndEffectorStates.HOLDING_CORAL)) {
            targetRotations = EndEffectorConstants.READY_FOR_CORAL - currentPosition;
        } else {
            targetRotations = EndEffectorConstants.HOLD_CORAL - currentPosition;
        }
    }
